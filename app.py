...
st.markdown("""
    <style>
        ...
        /* SMOOTH IFRAME TRANSITION (Anti-Flash) */
        iframe {
        ...
        def interactive_dashboard_fragment(patient_df, mapping_df, geo_data, min_date, max_date, data_source):
            ...
            with st.sidebar:
                ...
                def on_filter_change():
                    st.toast("Applying Filters & Updating View...", icon="⏳")
            ...
            # --- FAST FOLIUM MAP RENDERING (NO DESTRUCTIVE SPINNER) ---
            with st.container(border=True):
                ...
                if geo_data:
                    # Removed st.spinner to prevent iframe destruction flash
                    ...
                    # 🚀 FIX: Added fixed key to prevent Folium DOM destruction
